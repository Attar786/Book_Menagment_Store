            ...
            <tbody>
              {books.length > 0 ? (
                books.map((book, index) => (
                  <tr key={book._id}>
                    <td className="border border-slate-600 rounded-md text-center align-middle ">{index + 1}</td>
                    ...
                    <td className="border border-slate-600 rounded-md max-md-hidden align-middle text-center">{book.publishYear}</td>
